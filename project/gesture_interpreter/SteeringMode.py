        ...
        if results.multi_hand_landmarks: 
            ...
            for idx, hand_landmarks in enumerate(results.multi_hand_landmarks):
                ...
                if label == "Left":
                    ...
                    fingers_up = sum(fingerUP) > 0
                    up_active = handle_key(fingers_up, Key.up, keyboard, up_active)
                ...
                if label == "Right":
                    ...
                    left_active = handle_key(navigation == "left", Key.left, keyboard, left_active)
                    right_active = handle_key(navigation == "right", Key.right, keyboard, right_active)
